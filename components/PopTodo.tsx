...
const PopTodo = () => {
  ...
  >
    ...
    >
      {/* card */}
      <div className='mt-20 opacity-1  sm:mt-0 fadeInGSAP '>
        <div
        ...
        {/* items in card box */}
        <div
          className='opacity-1 popUpMenu z-20 relative  inline-block align-bottom bg-white rounded-lg 
